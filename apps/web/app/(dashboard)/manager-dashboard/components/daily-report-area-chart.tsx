...
export function DailyReportAreaChart() {
  ...
  const formatLabel = React.useCallback((value: string | number) => {
    ...
    <Card className="pt-0">
      <CardHeader className="flex flex-col items-start gap-2 space-y-0 border-b py-5 sm:flex-row sm:items-center">
        <div className="grid flex-1 gap-1">
          <CardTitle>Channel demand</CardTitle>
          <CardDescription>Mock visitor mix for the current quarter.</CardDescription>
        </div>
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer config={chartConfig} className="h-[280px] w-full">
          <AreaChart data={filteredData}>
            ...
            <ChartTooltip
              cursor={false}
              content={<ChartTooltipContent indicator="dot" labelFormatter={(value) => formatLabel(value)} />}
            />
