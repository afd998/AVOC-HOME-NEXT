...
export default async function FacultyProfile({
  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col gap-6 overflow-hidden bg-background text-foreground border border-white/20 dark:border-white/10 p-3 sm:p-6">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto sm:space-y-6 pr-1 min-h-0">
        <Suspense
