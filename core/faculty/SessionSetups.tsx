...
const PANEL_IMAGE_FALLBACK = "/images/panel-fallback.png";
...
const PANEL_OPTION_MAP = PANEL_OPTIONS.reduce<Record<string, PanelOption>>(
  (acc, option) => {
...
const getPanelImageSrc = (panelId?: string | null) => {
