...
import {
  useEventOwnership,
  useAssignManualOwner,
  useClearManualOwner,
} from "../../../ref/useCalculateOwners";
...
export default function OwnerDisplay({ event }: OwnerDisplayProps) {
      ...
      <>
        <Item variant="outline" size="sm" className="mb-3 sm:mb-4">
          <ItemContent>
            ...
            <ItemDescription>No owners found for this event</ItemDescription>
          </ItemContent>
          {!hasManualOwner && (
            <ItemActions>
        ...
        <UserSelectionModal
          ...
          title={
            hasManualOwner ? "Select Initial Owner" : "Select Manual Owner"
          }
        />
      </>
    );
                ...
                <React.Fragment key={entry.ownerId}>
                  ...
                  <span className="relative inline-flex">
                      ...
                      content={
                        <div>
                          ...
                          <div className="text-xs text-gray-300 mt-1">
                            {hasManualOwner
                              ? "Click to change manual assignment"
                              : "Auto-assigned owner"}
                          </div>
                        </div>
                      }
                    ...
                    {hasManualOwner && (
                      <button
                        onClick={() =>
                          clearManualOwnerMutation.mutate({ eventId: event.id })
                        }
