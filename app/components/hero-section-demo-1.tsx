      ...
      <div className="px-4 py-10 md:py-20">
        <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-700 md:text-4xl lg:text-7xl dark:text-slate-300">
          {titleWords.map((word, index) => (
            <span
              key={index}
              className="mr-2 inline-block transition-opacity duration-500 ease-in-out"
            >
              {word}
            </span>
          ))}
        ...
        <div className="relative z-10 mt-8 flex flex-wrap items-center justify-center gap-4 transition-opacity duration-700 ease-in-out">
          ...
          <Link href="https://avoc-proposal.vercel.app">
        ...
        <div className="relative z-10 mt-20 rounded-3xl border border-neutral-200 bg-neutral-100 p-4 shadow-md transition-opacity duration-1000 ease-in-out dark:border-neutral-800 dark:bg-neutral-900">
          <div className="w-full overflow-hidden rounded-xl border border-gray-300 dark:border-gray-700">
              ...
              <Image
                src="/images/landdark.png"
                alt="Landing page preview"
                className="aspect-[16/9] h-auto w-full object-cover hidden dark:block"
                height={1000}
                width={1000}
              />
              ...
              <Image
                src="/images/land.png"
                alt="Landing page preview"
                className="aspect-[16/9] h-auto w-full object-cover block dark:hidden"
                height={1000}
                width={1000}
              />
